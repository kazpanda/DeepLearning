第一回AI実装検定申込み締め切り　3月13日（金）～E資格への第一歩～
...
1. 対象物がどこにあるかをボックスに切り取り,対象物を推定するタスク
1. 対象物体と背景をピクセルごとに詳細に切り分けて,そのピクセルごとが示す意味を推定するタスク
1. ある入力値を入力したときに,その入力に基づいて画像を生成するタスク
...
1. 対象としている画像のそのものが何かを推定するタスク
1. 対象物がどこにあるかをボックスに切り分けて,対象物を推定するタスク
1. 対象物体と背景をピクセルごとに詳細に切り分けて,そのピクセルごとが示す意味を推定するタスク
1. ある入力値を入力したときに,その入力に基づいて画像を生成するタスク
